...
//Use the following IDENTIFIERS for the variables and
//make sure the variables are of the following TYPE
//(meaning they can store VALUES of that TYPE).

//identifier “x” type int, identifier “y” type string, identifier “z” type bool
